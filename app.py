...
def producer_send_alert(rental_id):
    ...
    try:
        ...
        google_webhook_url = os.environ.get("GOOGLE_WEBHOOK_URL", "https://script.google.com/macros/s/AKfycbwweRfo7blGEmJggNO3_lagPP468uK1_6DdD-mjRcrvUF-oG1UvVJ2gGespy2xmVv3o/exec")
        if not google_webhook_url:
            ...
            try:
                ...
                traceback.print_exc()
                flash(f"Failed to send email via webhook: {e}", "danger")
